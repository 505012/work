...
// 예) 사람, 사물 등
// 객체 요소 :  1) 속성(특징 나타냄, 90%), 2) 함수(행동, 동작)
// 비교) css 사용법
// 선택자{
//     속성:값;
//     속성2;값2;
...
// 자료형 : 문자열(string), 숫자(number), 참/거짓(bool/boolean), 배열(객체), 객체, null, undefined, 참고)Symbol(1%)
// null 자료형: 변수는 있으나 공간이 비어 있는 것(js, 자바, c/c++ 등)
// 예제) 변수에 null넣기
let char1 = null;//사용법. 과거코딩(변수 초기화 많이 사용)
// 현재는 null초기화 권장하지 않음(버그가 많이 발생함)
let char2 = ""// 빈문자열 초기화
let num = 0;//숫자 초기화

// 메모리 : 프로그램 실행시키면 -> 컴퓨터 메모리에 올라감
// todo : undefined 자료형 : js에만 있음, 다른 언어는 없음
// 객체의 속성명이 정의 되지 않은것
// 객체 정의
let dog = {
    name : "삼순이",
...
// undefined 에러 발생함
console.log("code", dog.code)// code속성 정의되지 않았음