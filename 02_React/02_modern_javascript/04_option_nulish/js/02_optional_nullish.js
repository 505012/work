...
// 개선된 예제 : 옵션널 널리쉬 사용
// user 가 null 이면 강제로 undifined 값으로 변경함
// 사용법 : 변수명?.속성명
let user = null; // 객체 , address속성이 있는지 없는지 체크
// 객체의 속성호출 user.address => user = null
                //null.address (에러 : 서비스 다운) 
console.log(`user는 ${user?.address}`)

// githun든 다른 디스크 등 모두 고장으로 인해 삭제될 수 있다
// 백업본을 항상 간직한다.
